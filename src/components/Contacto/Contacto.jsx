        ...
        <div className='footer'>
            <div className='container-body'>
                <section className='column1'>
                    ...
                    <p>En <strong>Pesca-Mar</strong>, somos apasionados por todo lo relacionado con la pesca. Ya sea que seas un pescador experimentado o estés comenzando en este emocionante mundo, estamos aquí para satisfacer todas tus necesidades de pesca. <br /> 
            ...
            <section className="column3">
                ...
                <div className="footer-row">
                    ...
                    <a className="link" href="https://goo.gl/maps/HEG2ZeaaEfGmyB8V7" target="_blank">Av. Hipólito Yrigoyen
                        325, X5000 Córdoba</a>
                </div>
                <div className="footer-row">
                ...
                <div className="footer-row">
                    <a href="mailto:tubuenapesca@gmail.com"><img src="./media/footer/email.png"
                            alt="icono-mail"/></a>
                    <a className="link" href="mailto:pesca-mar@gmail.com">pesca-mar@gmail.com</a>
                </div>
            </section>
            </div>
        </div>
